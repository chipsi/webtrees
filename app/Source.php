...
class Source extends GedcomRecord
{
    ...
    {
        return app(SourceFactory::class)->mapper($tree);
    }
    ...
    {
        return app(SourceFactory::class)->make($xref, $tree, $gedcom);
    }
    ...
    {
        $repository_factory = app(RepositoryFactory::class);
        assert($repository_factory instanceof RepositoryFactory);
