...
class GedcomRecordFactory extends AbstractGedcomRecordFactory
{
    ...
    public function make(string $xref, Tree $tree, string $gedcom = null): ?GedcomRecord
    {
        ...
        return
            ...
            app(SubmissionFactory::class)->make($xref, $tree, $gedcom) ??
            app(HeaderFactory::class)->make($xref, $tree, $gedcom) ??
    ...
    private function newGedcomRecord(string $type, string $xref, string $gedcom, ?string $pending, Tree $tree): ?GedcomRecord
    {
        switch ($type) {
            ...
            case Header::RECORD_TYPE:
                return app(HeaderFactory::class)->new($xref, $gedcom, $pending, $tree);
            ...
            case Submission::RECORD_TYPE:
                return app(SubmissionFactory::class)->new($xref, $gedcom, $pending, $tree);
